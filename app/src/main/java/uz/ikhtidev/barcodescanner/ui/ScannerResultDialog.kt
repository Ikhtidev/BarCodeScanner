...
import uz.ikhtidev.barcodescanner.databinding.FragmentScannerResultDialogListDialogBinding
...
class ScannerResultDialog(private val listener: DialogDismissListener) : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCopy.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Buferga nusxalandi", Toast.LENGTH_SHORT).show()
